    ...
    <v-row justify="center">
      <v-col cols="12">
        <v-card class="app-cards" outlined width="100%">
          ...
          <v-form ref="form" v-model="valid" @submit.prevent="searchArticle">
            <v-card-text>
              <v-row>
                <v-col md="6" cols="12">
                  <v-text-field
                ...
                <v-col cols="12">
                  <div class="results">
                    ...
                    <span
                      v-if="!firstSearch && results.length === 0 && !loading"
                      class="headline text-center"
                    >
                      Não foram encontradas publicações com o termo e filtro
                      pesquisado
                    </span>
                    <publications-table
                      v-if="
                    ...
                    <div
                      v-if="
                        results.length > 0 && !loading && $vuetify.breakpoint.xs
                      "
                  ...
                  <div
                    ...
                    :class="{
                      'column align-center text-center': $vuetify.breakpoint.xs,
                    }"
                  >
                    <span
                      >Encontrou alguma inconsistência? Fale conosco no
                      email&nbsp;</span
                    >
                    <a class="primary--text" href="mailto:connepirep@gmail.com">
