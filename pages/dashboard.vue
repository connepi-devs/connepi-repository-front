<template>
  <v-container style="margin-top: -50px" grid-list-lg>
    ...
    <v-row wrap>
      <!-- Cards -->
      <v-col cols="12">
        <cards :cards-data="articlesPerYear" />
      </v-col>
      <!-- Charts and Tables -->
      <v-col cols="12" lg="6">
        <articles-per-area :chart-data="articlesPerArea" />
      </v-col>
      <v-col cols="12" lg="6">
        <institutes-ranking :chart-data="totalArticlesPerInstituteData" />
      </v-col>
      <v-col cols="12">
        <articles-per-area-per-institute-per-year
          :chart-data="articlesPerInstitutePerAreaPerYearWithFilter"
          :institutes="institutes"
          @filter="filter"
        />
      </v-col>
      <v-col cols="12">
        <articles-per-institute :chart-data="totalArticlesPerInstituteData" />
      </v-col>
      <v-col cols="12">
        <articles-per-area-per-year
          :chart-data="articlesPerInstitutePerAreaPerYearData"
        />
      </v-col>
    </v-row>
  </v-container>
      ...
      Promise.all([
        ...
        .then(
          ([
            ...
            getArticlesCountByArea,
            getArticlesCountByYear,
          ]) => {
            this.institutes = getInstitutes.data;
            // eslint-disable-next-line
            this.articlesPerInstitutePerAreaPerYearWithFilter =
              getArticlesPerInstitutePerAreaPerYear.data;
            // eslint-disable-next-line
            this.articlesPerInstitutePerAreaPerYearData =
              getArticlesPerInstitutePerAreaPerYear.data;
            this.totalArticlesPerInstituteData =
              getTotalArticlesPerInstitute.data;
